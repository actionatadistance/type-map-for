...
/** Avro type for a single field value.
 *
 *  required scalar    → 'string'
 *  optional scalar    → ['null', 'string']
 *  required array     → { type: 'array', items: 'string' }
 *  optional array     → ['null', { type: 'array', items: 'string' }]
 */
